...
const ProjectDetails = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center w-full h-full overflow-auto backdrop-blur-sm p-4">
            <motion.div
                className="relative w-full max-w-2xl mx-auto my-auto border shadow-sm rounded-2xl bg-gradient-to-l from-midnight to-navy border-white/10 max-h-[90vh] overflow-y-auto"
            ...
            >
                ...
                />
                <div
                    className="p-8 max-sm:p-4 max-sm:text-sm"
                    style={{ border: '10px solid rgba(255, 255, 255, 0.1)' }}
                >
                    <h5 className="mb-2 text-2xl font-bold text-white max-sm:text-xl">
                        {title}
                    </h5>
